                                        ...
                                        <div class="payment-gateway-list d-flex  justify-content-between align-items-center">
                                            <div class="single-gateway-item">
                                                ...
                                                <div class="payment-content d-flex gap-10" >
                                                    ...
                                                    @else
                                                        <input name="payment_method" class="radio" type="radio" value="{{ $payment_method->name }}" checked>
                                                    @endif
                                                     <input name="payment_method" class="radio" type="radio"  value="{{ $payment_method->name == 'offline' ? 'offline' : $payment_method->name }}">
                                                </div>
                                            </div>
                                        </div>
                                    </label>
...
{{--                                    @include('paynetgateway::__payment_info', ['amount' => @$amount])--}}
{{--                                @endif--}}
                    ...
                    <div class="col-lg-4">
                        <div class="summary-card">
                            ...
                            <div class="checkout-btn d-grid mb-16" id="complete_payment">
                                <button class="btn-primary-fill btn-block"
                                    type="submit" id="payBtn" >{{ ___('frontend.Complete Payment') }}</button>
                            </div>
                        </div>
                    </div>
                </div>

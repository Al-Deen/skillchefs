...
<section class="ot-brand-area section-padding2"  @if(@$section->color) style="background:{{ @$section->color }}" @endif>
    @if (!empty($data['brands']))
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-12">
                <div class="section-tittle text-center mb-15">
                    <h3 class="text-capitalize font-600">{{ @$data['brand_section_title'] }}</h3>
                </div>
            </div>
        </div>
        <div class="row">

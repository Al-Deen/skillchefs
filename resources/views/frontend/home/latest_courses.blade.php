    ...
    <section class="ot-latest-courses-area section-padding"  @if(@$section->color) style="background:{{ @$section->color }}" @endif>
        <div class="container">
            <div class="row">
                {{-- Section Title --}}
                <div class=" col-xl-12">
                    <div class="d-flex align-items-start flex-wrap gap-10 mb-45">
                        <div class="section-tittle flex-fill">
                            <h3 class="text-capitalize font-600">{{ $latestdata['title'] }}</h3>
                        </div>
                        <a class="btn-primary-fill bisg-btn" href="{{ $latestdata['url'] }}">
            ...
            <div class="row g-24">
                @foreach ($latestdata['courses'] as $course)

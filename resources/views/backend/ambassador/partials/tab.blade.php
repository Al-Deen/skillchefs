                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img class="img-fluid rounded-circle"
                                    src="{{ showImage( @$data['ambassador']->user->image->original, 'default-1.jpeg') }}"
                                    width="60" alt="profile image" />
                            </div>
                            <div class="flex-grow-1">
                                <div class="body">
                                    <h2 class="title">{{  @$data['ambassador']->user->name }}</h2>
                                    <p class="paragraph">{{  @$data['ambassador']->designation }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="profile-menu-body">
                        <nav>
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link {{ menu_active_by_url(route('admin.ambassador.edit', [ $data['ambassador']->id, 'general'])) }}"
                                        href="{{ route('admin.ambassador.edit', [ $data['ambassador']->id, 'general']) }}">
                                        {{ ___('common.General') }}
                                    </a>
                                </li>
                                <li class="nav-item">

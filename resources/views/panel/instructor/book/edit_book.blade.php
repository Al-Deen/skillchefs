...
@section('content')
    ...
    <section class="create-new-course" id="course_step">
        ...
        <!-- MultiStep End -->
        <form action="{{ route('instructor.book.update', $data['book']->slug) }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="ot-contact-form mb-24">
                            ...
                            <input class="form-control ot-contact-input" type="text" name="title" id="title"
                                   value="{{ $data['book']->title }}" placeholder="Book Title" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        @php
                            ...
                            $shortFile =  \App\Models\Upload::find($data['book']->short_file);
                            $fullFile =  \App\Models\Upload::find($data['book']->full_file);
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="point_title[]" class="form-control" placeholder="Enter the title"
                                                           value="{{ $point_title }}" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="required">Description</label>
                                                    <textarea class="form-control ot-textarea" name="point_description[]" rows="5" placeholder="Enter Short Description" required>{{ $descriptions[$key] ?? '' }}</textarea>
                                                </div>

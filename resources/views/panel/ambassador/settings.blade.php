        ...
        <div class="col-xl-12">
            ...
            <ul class="nav course-details-tabs setting-tab mb-40" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a href="{{ route('ambassador.setting', ['edit']) }}"
                        class="nav-link {{ url()->current() === route('ambassador.setting', ['edit']) ? 'active' : '' }}"
                ...
                <li class="nav-item" role="presentation">
                    <a href="{{ route('ambassador.setting', ['security']) }}"
                        class="nav-link {{ url()->current() === route('ambassador.setting', ['security']) ? 'active' : '' }}"
                        type="button" role="tab">
                ...
                <li class="nav-item" role="presentation">
                    <a href="{{ route('ambassador.setting', ['educations']) }}"
                        class="nav-link {{ url()->current() === route('ambassador.setting', ['educations']) ? 'active' : '' }} "
                        type="button" role="tab"> <i class="ri-book-open-line"></i>
                        <span>{{ ___('instructor.Educations') }}</span>
                    </a>
                </li>
{{--                <li class="nav-item" role="presentation">--}}
{{--                    <a href="{{ route('ambassador.setting', ['experiences']) }}"--}}
{{--                        class="nav-link {{ url()->current() === route('ambassador.setting', ['experiences']) ? 'active' : '' }} "--}}
{{--                        type="button"role="tab">--}}
...
{{--                </li>--}}
{{--                <li class="nav-item" role="presentation">--}}
{{--                    <a href="{{ route('ambassador.setting', ['skills']) }}"--}}
{{--                        class="nav-link {{ url()->current() === route('ambassador.setting', ['skills']) ? 'active' : '' }} "--}}
{{--                        type="button" role="tab">--}}
...
{{--                </li>--}}
                @if (module('LiveClass'))
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('ambassador.setting', ['live-class']) }}"
                            class="nav-link {{ url()->current() === route('ambassador.setting', ['live-class']) ? 'active' : '' }} "
                            type="button" role="tab">
                ...
                @if (module('TwoFA') && setting('two_fa_setup'))
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('ambassador.setting', ['two_fa']) }}" class="nav-link {{ url()->current() === route('ambassador.setting', ['two_fa']) ? 'active' : '' }} "
            ...
            <div class="tab-content" id="myTabContent">
                @if (url()->current() === route('ambassador.setting', ['edit']))
                    <div class="tab-pane fade show active">

                        <!-- General info start -->
                        <form action="{{ route('ambassador.update_profile') }}" method="POST"
                                ...
                                <div class="col-xl-6 col-lg-12">
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        ...
                                        <input
                                            ...
                                            value="{{ date_picker_format(@$data['ambassador']->date_of_birth) }}"
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        ...
                                        <input class="form-control ot-contact-input @error('address') is-invalid @enderror"
                                            type="text" name="address" value="{{ @$data['ambassador']->address }}"
...
{{--                                    </div>--}}
                                ...
                                <div class="col-xl-6 col-lg-12">
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        ...
                                        <input
                                            ...
                                            value="{{ @$data['ambassador']->designation ?? old('designation') }}"
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        ...
                                        <textarea class="ot-contact-textarea @error('about_me') is-invalid @enderror"
                                            placeholder="{{ ___('instructor.About My Self') }}" name="about_me" id="" rows="10">{{ @$data['ambassador']->about_me ?? old('about_me') }}</textarea>
                                        @error('about_me')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                ...
                @elseif (url()->current() === route('ambassador.setting', ['security']))
                    <div class="tab-pane fade show active">
                        <!-- Security -->
                        <form action="{{ route('ambassador.update_password') }}" class="Security" method="post">
                            @csrf
                            <div class="row">
                ...
                @elseif (url()->current() === route('ambassador.setting', ['educations']))
                    <div class="tab-pane fade show active">
                        <!-- Educations -->
                        <div class="col-xl-12">
                            <div
                                ...
                                <button class="btn-primary-outline"
                                    onclick="mainModalOpen(`{{ route('ambassador.addInstitute') }}`)"><i
                                        class="ri-add-line"></i> {{ ___('instructor.add new') }}</button>
                            </div>
                        </div>
                        <div class="row">
                            @if (@$data['ambassador']->education)
                                @foreach (@$data['ambassador']->education as $key => $institute)
                                    <div class="col-xl-12">
                                        <div
                ...
                @elseif (url()->current() === route('ambassador.setting', ['experiences']))
                    {{-- Experience Section --}}
                    <div class="tab-pane fade show active">
                        <div class="col-xl-12">
                            <div
                        ...
                        <div class="row">
                            @if (@$data['ambassador']->experience)
                                @foreach (@$data['ambassador']->experience as $key => $experience)
                                    <div class="col-xl-12">
                                        <div
                                            class="single-education mb-30 d-flex justify-content-between align-items-start">
                                            <div class="education-cap">
                                            ...
                                            <div class="d-flex gap-10">
                                                <button class="btn text-primary border-0 p-0 action-success"
                                                    onclick="mainModalOpen(`{{ route('ambassador.edit.experience', [$key]) }}`)"><i
                                                        class="ri-pencil-line"></i></button>
                                                <button class="btn text-tertiary border-0 p-0 action-danger"
                                                    onclick="destroyFunction(`{{ route('ambassador.delete.experience', [$key]) }}` )"><i
                                                        class="ri-delete-bin-line"></i></button>
                                            </div>
                    ...
                    {{-- End Experiences --}}
                @elseif (url()->current() === route('ambassador.setting', ['skills']))
                    <!-- Skills & Expertise -->
                    <div class="tab-pane fade show active">
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="col-xl-12">
                                    <div
                                        ...
                                        <button class="btn-primary-outline"
                                            onclick="mainModalOpen(`{{ route('ambassador.add.skill') }}`)"><i
                                                class="ri-add-line"></i> {{ ___('instructor.add new') }}</button>
                                    </div>
                                </div>
                                <!-- add -->
                                <div class="single-education mb-30 d-flex justify-content-between align-items-start">
                                    <div class="tag-area3">
                                        <ul class="listing">
                                            @if (@$data['ambassador']->skills)
                                                @foreach (@$data['ambassador']->skills as $key => $skill)
                ...
                @elseif (module('LiveClass') && url()->current() === route('ambassador.setting', ['live-class']))
                    <!-- live-class -->
                    <div class="tab-pane fade show active">
                    ...
                    {{-- End live-class --}}
                @elseif (module('TwoFA') && setting('two_fa_setup') && url()->current() === route('ambassador.setting', ['two_fa']))

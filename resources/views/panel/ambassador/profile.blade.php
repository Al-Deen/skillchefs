        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="section-tittle-two d-flex align-items-center justify-content-between flex-wrap mb-20">
                    <h2 class="title font-600">{{ ___('instructor.My profile') }}</h2>
                    <span class="action-success" id="copyButton" data-url="{{ route('share.profile', ['username' => @$data['ambassador']->user->username ])}}">
                    ...
                    <div class="my-profile-card radius-6 ot-card">
                        <div class="d-flex flex-wrap align-items-center gap-20 border-bottom mb-20 pb-15 ">
                            ...
                            <div class="profile-image">
                                <img src="{{ showImage(@$data['ambassador']->user->image->original, 'default-1.jpeg') }}"
                                    class="img-cover" alt="img">
                            </div>
                            <div class="caption">
                                <h6 class="profile-name font-600">{{ @$data['ambassador']->user->name }}</h6>
                                <p class="text-14 text-{{ @$data['ambassador']->user->userStatus->class }}">
                                    {{ @$data['ambassador']->user->userStatus->name }}
                                </p>
                                <p class="profile-user-name font-500">{{ @$data['ambassador']->user->email }}</p>
                                <p class="profile-designation mb-10">{{ @$data['ambassador']->designation }}</p>
                                <div class="country d-flex align-items-center mb-10">
                                    <span class="country text-title font-600">
                                        {{ @$data['ambassador']->country->name }}</span>
                                    <i class="fi fi-{{ strtolower(@$data['ambassador']->country->code) }}"></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <p class="pera mb-30">{!! @$data['ambassador']->about_me !!}</p>


{{--                        <div class="country d-flex align-items-center mb-10">--}}
{{--                            <i class="ri-briefcase-line"></i>--}}
{{--                            <span class="country text-title font-600 ml-10">{{ ___('instructor.Current Status') }}</span>--}}
{{--                        </div>--}}
{{--                        <div class="row">--}}
...
{{--                        <!-- Experience -->--}}
{{--                        <div class="country d-flex align-items-center mb-10">--}}
{{--                            <span class="country text-title font-600">{{ ___('instructor.Years of Experience') }}</span>--}}
{{--                        </div>--}}

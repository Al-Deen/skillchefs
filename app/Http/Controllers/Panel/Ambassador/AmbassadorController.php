...
class AmbassadorController extends Controller
{
    ...
    {
        try {
            $data['title'] = ___('instructor.Ambassador'); // title
            ...
            return view('panel.ambassador.dashboard', compact('data'));
        } catch (\Throwable $th) {
    ...
    public function profile()
    {
        try {
            ...
            $data['ambassador'] =Ambassador::with('user')->where('user_id', auth()->user()->id)->first();

            return view('panel.ambassador.profile', compact('data'));
        } catch (\Throwable $th) {
            return redirect()->back()->with('danger', ___('alert.something_went_wrong_please_try_again'));
        }
    }
    ...
    public function logout()
    {
        try {
            ...
            return redirect()->route('home')->with('success', 'Ambassador Log out successfully!!');
        } catch (\Throwable $th) {
            return redirect()->back()->with('danger', ___('alert.something_went_wrong_please_try_again'));
        }
    }
